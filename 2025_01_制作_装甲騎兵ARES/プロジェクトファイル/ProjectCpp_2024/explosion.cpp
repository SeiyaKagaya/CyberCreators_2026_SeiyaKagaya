...
void CExplosion::InputpVtx()
{
	...
	//頂点座標の更新-----------------------------------
	EscVtx[0].pos.x = EscData.Pos.x - EX_WIDE;//左上
	EscVtx[0].pos.y = EscData.Pos.y - EX_HEIGHT;//左上
	EscVtx[0].pos.z = 0.0f;

	EscVtx[1].pos.x = EscData.Pos.x + EX_WIDE;//右上
	EscVtx[1].pos.y = EscData.Pos.y - EX_HEIGHT;//右上
	EscVtx[1].pos.z = 0.0f;

	EscVtx[2].pos.x = EscData.Pos.x - EX_WIDE;//左下
	EscVtx[2].pos.y = EscData.Pos.y + EX_HEIGHT;//左下
	EscVtx[2].pos.z = 0.0f;

	EscVtx[3].pos.x = EscData.Pos.x + EX_WIDE;//右下
	EscVtx[3].pos.y = EscData.Pos.y + EX_HEIGHT;//右下
	EscVtx[3].pos.z = 0.0f;
