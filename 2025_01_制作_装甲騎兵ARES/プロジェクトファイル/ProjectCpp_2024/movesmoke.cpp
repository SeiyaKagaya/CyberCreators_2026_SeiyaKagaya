...
//
//    int texIndex = pTexture->Regist("DATA\\TEXTURE\\Effect_Smoke000.png", EscDevice);//テクスチャ登録
//
...
//// 座標設定
////=============================
//void CMoveSmoke::SetPos_Rot(D3DXVECTOR3 Pos)
//{
//    //取得
...
//{
//   /* CMoveSmoke* pObject3D = new CMoveSmoke;
